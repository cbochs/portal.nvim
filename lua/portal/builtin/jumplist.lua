...
function Jumplist.tunnel_forward(opts)
    Jumplist.tunnel(vim.tbl_extend("force", opts, { direction = "forward" }))
end

function Jumplist.tunnel_backward(opts)
    Jumplist.tunnel(vim.tbl_extend("force", opts, { direction = "backward" }))
end
